...
let hasTechDeal = cartA.includes("latop") || cartA.includes("camera") || cartB.includes("laptop") || cartB.includes("camera");
...
let displayName = rawName.trim().split(" ")[0].toLowerCase();
displayName = displayName.charAt(0).toUpperCase() + displayName.slice(1);

// Create 'hasProgram' that is TRUE if the (trimmed, lowercased) string contains "program".
// Create 'hasProgram' that is TRUE if the (trimmed, lowercased) string contains "program"
let hasProgram = rawName.trim().toLowerCase().includes("program");
